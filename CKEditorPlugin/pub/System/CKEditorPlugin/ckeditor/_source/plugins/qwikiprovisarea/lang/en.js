...
CKEDITOR.plugins.setLang( 'qwikiprovisarea', 'en',
{
	qwikiflowchart: {
		...
		nodes			: 'Process Types',
		nodes_start		: 'Start',
		nodes_process		: 'Process step',
		nodes_decision		: 'Decision',
		nodes_comment		: 'Comment',
		nodes_join		: 'Junction',
		nodes_database		: 'Database',
		nodes_document		: 'Document',
		nodes_end		: 'End',
		resize			: 'ProVis Window Size',
		saveoptions		: 'Display mode',
		saveoptions_frame	: 'Frame',
		saveoptions_line	: 'Simple dividers',
		saveoptions_noframe	: 'No frame',
