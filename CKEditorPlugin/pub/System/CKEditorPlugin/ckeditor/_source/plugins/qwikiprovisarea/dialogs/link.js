								...
								[
									...
									},
									{
										...
										onShow : function()
										{
											...
											var options = {
													script: FoswikiCKE.getFoswikiVar("VIEWSCRIPTURL") + "/Sandbox/AjaxHelper?section=topic;contenttype=text/plain;skin=text;baseweb=all,-Trash,-System;format=$topic,$web,$web.$topic;",
													varname:"input",
													link:true,
													shownoresults:false,
													maxresults:16,
