...
CKEDITOR.plugins.setLang( 'qwikiprovisarea', 'de',
{
	qwikiflowchart :
	{
		...
		nodes			: 'Prozesstypen',
		nodes_start		: 'Start',
		nodes_process		: 'Prozessschritt',
		nodes_decision		: 'Entscheidung',
		nodes_comment		: 'Kommentar',
		nodes_join		: 'Knotenpunkt',
		nodes_database		: 'Datenbank',
		nodes_document		: 'Dokument',
		nodes_end		: 'Ende',
		resize			: 'ProVis Fenstergr\u00F6\u00DFe',
		saveoptions		: 'Darstellungsmodus',
		saveoptions_frame	: 'Rahmen',
		saveoptions_line	: 'Einfache Trennlinien',
		saveoptions_noframe	: 'Ohne Rahmen',
