...
(function()
{
	...
	function tableDialog( editor, command )
	{
		...
		var getAdvSetting = function( setting )
		{
			if (editor.config.advancedFeatures === undefined) return false;
			return editor.config.advancedFeatures[setting];
		}
							...
							[
								{
									...
									{
										/* Modac : Stylesheet Klassen ‹bernehmen
									...
									[
										...
										},
										{
											...
											commit : function( data, selectedTable )
											{
												if ( this.getValue() )
												{
													//Alex: Align zerschie√üt Tabellen, daher raus:
