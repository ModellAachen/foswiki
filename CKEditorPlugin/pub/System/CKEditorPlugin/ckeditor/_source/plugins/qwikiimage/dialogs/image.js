													...
													[
														{
															...
															validate : function()
															{
																...
																if ( !aMatch )
																	alert( editor.lang.qwiki.validateWidth );
																return !!aMatch;
															},
														...
														},
														{
															...
															validate : function()
															{
																var aMatch = this.getValue().match( regexGetSizeOrEmpty );
																if ( !aMatch )
																	alert( editor.lang.qwiki.validateHeight );
																return !!aMatch;
															},
															setup : setupDimension,
															commit : function( type, element, internalCommit )
											...
											[
												{
													...
													validate : CKEDITOR.dialog.validate.integer( editor.lang.qwiki.validateBorder ),
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
												...
												},
												{
													...
													validate : CKEDITOR.dialog.validate.integer( editor.lang.qwiki.validateHSpace ),
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
												...
												},
												{
													...
													validate : CKEDITOR.dialog.validate.integer( editor.lang.qwiki.validateVSpace ),
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
									...
									[
										{
											...
											'<div class="ImagePreviewLoader" id="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div>'+
											'<div class="ImagePreviewBox" id="ImagePreviewBox">'+
					...
					[
						{
							type : 'file',
							id : 'filepath',
							label : editor.lang.qwiki.localFile,
							style: 'height:40px',
							size : 38,
							onChange : function()
							{
						...
						},
						{
							type : 'text',
							id : 'filename',
							label : editor.lang.qwiki.qwikiFileName,
							style : 'width: 60%',
							size : 20,
							onFocus : function()
							{
						...
						},
						{
							...
							hidden : 'true',
							id : 'uploadtarget',
							label : editor.lang.image.uploadTarget || "Upload Optionen",
							'default' : 'local',
							items :
								[
